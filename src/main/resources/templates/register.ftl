...
<input  id="username" name="username"  type="text" class="text" value="" placeholder="用户名" onfocus="this.value = '';" onblur="checkUserNameInfo()" >

<input id="password" name="password" type="password" value="" placeholder="密码" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '密码';}">
